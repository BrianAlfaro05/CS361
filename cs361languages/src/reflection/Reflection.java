...
public class Reflection {
	...
	public void inheritanceChain(Object o) {
		...
		Class x=o.getClass();
		System.out.print("o");
		while(!x.getSuperclass().getName().equals("java.lang.Object")) {
			System.out.print(" inherits from "+x.getSuperclass().getName());
			x=x.getSuperclass();
		}
		System.out.println(" inherits from "+x.getSuperclass().getName());
	}
