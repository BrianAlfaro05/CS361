...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		//emp3 is a PartTimeEmployee that has been casted to a Employee.
		
		// emp3.getHourlyRate(); // returns syntax error because ...
		
		//emp3 is still considered a employee, therefore it can't access the hourlyRate variable.
		...
		//emp1 is not a PartTimeEmployee so can not cast it.
